# 1 "c:\\users\\admin\\documents\\vugen\\scripts\\uc03_pokypka_biletov\\\\combined_UC03_Pokypka_biletov.c"
...
# 1 "c:\\users\\admin\\documents\\vugen\\scripts\\uc03_pokypka_biletov\\\\combined_UC03_Pokypka_biletov.c" 2
...
# 2 "c:\\users\\admin\\documents\\vugen\\scripts\\uc03_pokypka_biletov\\\\combined_UC03_Pokypka_biletov.c" 2
...
# 3 "c:\\users\\admin\\documents\\vugen\\scripts\\uc03_pokypka_biletov\\\\combined_UC03_Pokypka_biletov.c" 2
...
# 4 "c:\\users\\admin\\documents\\vugen\\scripts\\uc03_pokypka_biletov\\\\combined_UC03_Pokypka_biletov.c" 2
...
lr_start_transaction("03_01_Home_page");
	...
	web_custom_request("home.html_2", 
		...
		"Mode=HTTP", 
		"LAST");
lr_end_transaction("03_01_Home_page", 2);
...
lr_end_transaction("03_02_Login", 2);
...
lr_end_transaction("03_03_Flights", 2);
...
lr_start_transaction("03_04_Vvod_info");
	...
	lr_end_transaction("03_04_Vvod_info", 2);
	...
	lr_end_transaction("03_05_Vybor_reisov", 2);
...
lr_end_transaction("03_06_Oplata", 2);
	...
	web_custom_request("cancelallreservations.gif", 
		...
		"Snapshot=t199.inf", 
		"LAST");
lr_end_transaction("03_07_Broni", 2);
	...
	web_custom_request("home.html_3", 
		...
		"Mode=HTTP", 
		"LAST");
	lr_end_transaction("03_08_Exit", 2);


lr_end_transaction("03_Pokypka_biletov", 2);


	return 0;
}
# 5 "c:\\users\\admin\\documents\\vugen\\scripts\\uc03_pokypka_biletov\\\\combined_UC03_Pokypka_biletov.c" 2
...
# 6 "c:\\users\\admin\\documents\\vugen\\scripts\\uc03_pokypka_biletov\\\\combined_UC03_Pokypka_biletov.c" 2
